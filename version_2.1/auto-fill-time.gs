/**
 * This script aimed for auto filling the task time for each student based on their level in both quants and verbal
   It's mentioned as "F,S"
 */
    ...
    for each(var t in task) {
        ...
        for (n = 1; n < data.length; n++) {
            ...
            if (oldFormula != "") {
                ...
                if (checkType === "VOC" || checkType === "AWA") {
                    Logger.log("IN VOC");
                    if (vocType === 'F') {
...
// This function converts string representation of spreadsheet's index to integer representation
